...
const languageData = {
  ...
  telugu: {
    ...
    origin:
      'Telugu is a Dravidian language that originated around 1000 BCE in southern India, mainly in present-day Andhra Pradesh and Telangana. Its earliest inscriptions date back to around 200 BCE, evolving from Proto-Dravidian roots.',
    evolution:
      'Telugu developed through Old, Middle, and Modern stages, heavily influenced by Sanskrit and regional dynasties. It gained prominence as a literary language during the medieval period under the Cholas and Vijayanagara Empire.',
    geography:
      'Telugu is primarily spoken in Andhra Pradesh and Telangana and by communities in neighboring Indian states. It has a significant diaspora in countries like the US, Malaysia, and the Middle East. It is the third most spoken language in India and continues to expand globally.',
  ...
  tamil: {
    ...
    origin:
      'Tamil, one of the world’s oldest classical languages, originated from the Dravidian family and boasts written records dating back to at least the 3rd century BCE.',
    evolution:
      'It evolved through Old, Middle, and Modern Tamil, with rich literary traditions like Sangam poetry and major developments during the Bhakti movement.',
    geography:
      'Tamil is primarily spoken in Tamil Nadu (India) and northern Sri Lanka, with vibrant diaspora communities in Malaysia, Singapore, Canada, the UK, and beyond.',
